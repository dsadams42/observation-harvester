...
echo OASIS
echo Observation Acquisition and Spatial Information Synthesis
...
set "CODEX_BIN=%OASIS_CODEX_BIN%"
if "%CODEX_BIN%"=="" set "CODEX_BIN=%OBSERVATION_HARVESTER_CODEX_BIN%"
...
if not "%OASIS_PORT%"=="" (
  set "APP_PORT=%OASIS_PORT%"
) else if not "%OBSERVATION_HARVESTER_PORT%"=="" (
...
echo.
echo Starting OASIS at http://127.0.0.1:%APP_PORT%
