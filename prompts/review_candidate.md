...
4. Propose the smallest correction:
   ...
   - for component-input evidence, fix the component type, unit, time basis, or geography level
     only when the source supports the change,
...
Do not bypass the validator, invent missing source support, or convert component inputs into
direct occupancy observations or final occupancy estimates.
